	...
	function _getDefaultValuesStep3() {
		...
		if( $this->Session->read('Installation.dbType') ){
			...
			$data['Installation']['dbDataPattern'] = $_data['dataPattern'];
                        ...
                        $data['Installation']['dbHost'] = getenv('C4SA_MYSQL_HOST'); // Edit NIFTYCloudC4SA
                        $data['Installation']['dbPort'] = '3306';
                        $data['Installation']['dbPrefix'] = 'bc_';
                        $data['Installation']['dbName'] = getenv('C4SA_MYSQL_DB'); // Edit NIFTYCloudC4SA
                        $data['Installation']['dbUsername'] = getenv('C4SA_MYSQL_USER'); // Edit NIFTYCloudC4SA
                        $data['Installation']['dbPassword'] = getenv('C4SA_MYSQL_PASSWORD'); //Edit NIFTYCloudC4SA
